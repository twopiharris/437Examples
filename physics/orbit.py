""" orbit.py 
    add planetary orbit
    add mass to both objects
    gravitate to planet object
    gravitatate call in main loop
    remove ship boundary checking
    add path-drawing to ship
"""
...
def main():
    ...
    planet = Planet()
    allSprites = pygame.sprite.Group(ship, planet)
